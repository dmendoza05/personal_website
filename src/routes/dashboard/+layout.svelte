...
<header class="relative z-20 px-4 sm:px-6">
	<div class="grid grid-cols-[1fr_auto_1fr] items-center gap-3 relative py-6">
		<div class="h-full w-full max-w-full border-0 border-b border-white absolute top-0 pointer-events-none"></div>
...
<main class="relative z-10 mx-auto w-full max-w-full px-4 py-6 sm:px-6">
